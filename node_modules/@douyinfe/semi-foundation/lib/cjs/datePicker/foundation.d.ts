...
export declare type PresetPosition = ArrayElement<typeof strings.PRESET_POSITION_SET>;
export declare type BaseValueType = string | number | Date;
export declare type DayStatusType = {
    isToday?: boolean;
    isSelected?: boolean;
    isDisabled?: boolean;
...
export declare type TriggerRenderProps = {
    [x: string]: any;
    value?: ValueType;
    inputValue?: string;
...
export declare type DateOffsetType = (selectedDate?: Date) => Date;
export declare type DensityType = 'default' | 'compact';
export declare type DisabledDateType = (date?: Date, options?: DisabledDateOptions) => boolean;
export declare type DisabledTimeType = (date?: Date | Date[], panelType?: string) => ({
    disabledHours?: () => number[];
    disabledMinutes?: (hour: number) => number[];
    disabledSeconds?: (hour: number, minute: number) => number[];
});
export declare type OnCancelType = (date: Date | Date[], dateStr: string | string[]) => void;
export declare type OnPanelChangeType = (date: Date | Date[], dateStr: string | string[]) => void;
export declare type OnChangeType = (date?: Date | Date[] | string | string[], dateStr?: string | string[] | Date | Date[]) => void;
export declare type OnConfirmType = (date: Date | Date[], dateStr: string | string[]) => void;
export declare type OnPresetClickType = (item: PresetType, e: any) => void;
export declare type PresetsType = Array<PresetType | (() => PresetType)>;
export declare type RenderDateType = (dayNumber?: number, fullDate?: string) => any;
export declare type RenderFullDateType = (dayNumber?: number, fullDate?: string, dayStatus?: DayStatusType) => any;
export declare type TriggerRenderType = (props: TriggerRenderProps) => any;
export declare type ValueType = BaseValueType | BaseValueType[];
