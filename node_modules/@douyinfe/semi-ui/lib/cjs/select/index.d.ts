...
declare class Select extends BaseComponent<SelectProps, SelectState> {
    ...
    renderTag(item: [React.ReactNode, any], i: number, isCollapseItem?: boolean): JSX.Element;
    renderNTag(n: number, restTags: [React.ReactNode, any][]): JSX.Element;
    renderOverflow(items: [React.ReactNode, any][], index: number): JSX.Element;
